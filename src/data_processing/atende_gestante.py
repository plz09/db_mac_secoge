...
def read_atende_gestante_data():
    ...
    aba_avaliacao_diaria = 'Avaliação diária'
    ...
    df_avaliacao_diaria = remove_espacos_e_acentos(path_atende_gestante_registro_teleatendimentos, aba_selecionada=aba_avaliacao_diaria)
    ...
    return {
        ...
        'atende_gestante_avaliacao_diaria': df_avaliacao_diaria,
